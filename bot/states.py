...
class AdminStates(StatesGroup):
    ...
    waiting_for_conversion_categories = (
        State()
    )  # Waiting for conversion category numbers
    waiting_for_usernames_category = (
        State()
    )  # Waiting for a single category number to list usernames
