...
LOADING_STICKER_ID = (
    "CAACAgIAAxkBAAEVqDFpf0pGFIP-sRsnvOx-jWd1idNYOwACtCMAAphLKUjeub7NKlvk2TgE"
)
...
async def delete_loading_sticker(
    bot: Bot, chat_id: int, message_id: int | None, *, silent: bool = True
) -> bool:
    """
...
async def LoadingSticker(
    message: Message, bot: Bot | None = None, *, auto_delete: bool = True
