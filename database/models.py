...
class EventType(str, Enum):
    ...
    CLICK_PACKET_FIRST = "CLICK_PACKET_FIRST"
    CLICK_PACKET_SECOND = "CLICK_PACKET_SECOND"
    ...
    CLICK_EXAMPLE_REPORT = "CLICK_EXAMPLE_REPORT"
    CLICK_REFERRAL_LINK = "CLICK_REFERRAL_LINK"
